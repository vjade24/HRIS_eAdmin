<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="cBarangays.aspx.cs" Inherits="HRIS_eAdmin.View.Barangays"%>
                                                                       ...
                                                                       <asp:TemplateField HeaderText="ACTION">
                                                                           <ItemTemplate>
                                                                               <%--<asp:LinkButton ID="lnkEditRow" runat="server" CssClass="btn btn-danger btn-md" OnCommand="editRow_Command" CommandArgument='<%# Eval("barangay_code") %>'><i class="fa fa-edit"></i></asp:LinkButton>--%>
                                                                                <asp:ImageButton ID="imgbtn_editrow1" runat="server" height="20px" width="20px" ImageUrl="~/ResourceImages/final_edit.png" OnCommand="editRow_Command" CommandArgument='<%# Eval("barangay_code") %>'/>
                                                                                <asp:ImageButton ID="lnkDeleteRow" runat="server" height="20px" width="20px" ImageUrl="~/ResourceImages/final_delete.png" OnCommand="deleteRow_Command" CommandArgument='<%# Eval("barangay_code") + ", " + Eval("barangay_name") %>'/>
