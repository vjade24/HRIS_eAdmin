...
namespace HRIS_eAdmin.View
{
    public partial class Barangays : System.Web.UI.Page
    {
         ...
         protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            AddEdit_Mode = CommonDB.CONST_ADD;
        ...
        protected void editRow_Command(object sender, CommandEventArgs e)
        {
            ...
            AddEdit_Mode = CommonDB.CONST_EDIT;
        ...
        protected void gv_dataListGrid_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            if (sortingDirection == CommonDB.CONST_SORTASC)
            {
                SortDirectionVal = SortDirection.Descending;
                sortingDirection = CommonDB.CONST_SORTDESC;
            }
            else
            {
                    SortDirectionVal = SortDirection.Ascending;
                    sortingDirection = CommonDB.CONST_SORTASC;
                }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string saveRecord = AddEdit_Mode.ToString();

            string scriptInsertUpdate = string.Empty;

            if (saveRecord == CommonDB.CONST_ADD)
            { 
            ...
            else if (saveRecord == CommonDB.CONST_EDIT)
            {
                dtSource.Rows[0]["barangay_code"] = tbx_barangaycode.Text.ToString();
                dtSource.Rows[0]["barangay_name"] = tbx_barangayname.Text.ToString();
                dtSource.Rows[0]["municipality_code"] = ddl_municity.SelectedValue.ToString();
            ...
            if (saveRecord == CommonDB.CONST_ADD || saveRecord == CommonDB.CONST_EDIT)
            {
                ...
                if (saveRecord == CommonDB.CONST_EDIT)
                {
